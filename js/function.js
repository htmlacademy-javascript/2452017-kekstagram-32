...
const checkWorkTime = function  (Start, End, Meeting, timeMeeting) {
    ...
    const totalStartMinutes = parseInt(workStart[0] * 60) + parseInt(workStart [1]);
    const totalEndMinutes = parseInt (workEnd[0] * 60) + parseInt(workEnd[1]);
    const totalMeetingMinutes = parseInt (meetingStart[0] * 60) + parseInt(meetingStart[1]);

    if ((totalMeetingMinutes >=totalStartMinutes) && (totalMeetingMinutes + timeMeeting) <= totalEndMinutes){
